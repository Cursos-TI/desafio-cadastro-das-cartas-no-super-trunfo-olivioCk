...
int main() {
    ...
    printf("\nDigite o nome da care a populacao: ");
    ...
    super_poder01 = (float)populacao01 + area01 + PIB01 + (float) pontosTuristicos01 + PIBPerCapita01 + (1.0f / densidade01);

    densidade02 = populacao02 / area02;
    PIBPerCapita02 = (PIB02 * 1000000000.0) / populacao02;
    super_poder02 = (float)populacao02 + area02 + PIB02 +(float) pontosTuristicos02 + PIBPerCapita02 + (1.0f / densidade02);
